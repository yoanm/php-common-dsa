...
final class NAryTreeFactoryTest extends TestCase
{
    ...
    {
        $node = Factory::fromLevelOrderList($data, static fn(int $val) => new Node($val));

        self::assertNotNull($node);
        self::assertInstanceOf(Node::class, $node); // @phpstan-ignore staticMethod.alreadyNarrowedType
