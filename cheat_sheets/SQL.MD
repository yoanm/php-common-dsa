...
⚠️ This is executed after the `SELECT` statement (=> aliases are available for instance), **BUT before** sorting. In other terms, it means user can't predict which row will be used for the final output !
